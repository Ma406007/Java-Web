...
-- limit 起始索引,每页展示记录数
-- 查询第1页,每页展示5条
select * from emp e left join dept d on e.dept_id = d.id limit 0, 5;

-- 查询第2页,每页展示5条
select * from emp e left join dept d on e.dept_id = d.id limit 5, 5;

-- 查询第3页,每页展示5条
select * from emp e left join dept d on e.dept_id = d.id limit 10, 5;
